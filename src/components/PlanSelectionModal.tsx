...
const PlanSelectionModal: React.FC<PlanSelectionModalProps> = ({
  ...
  // ✅ group plans by data_gb
  const groupedPlans = plans.reduce((acc: Record<string, EsimPlan[]>, plan: EsimPlan) => {
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {Object.keys(groupedPlans).length === 0 ? (
            <div className="text-center py-12 text-gray-500">No eSIM plans available for this country.</div>
          ) : (
                      ...
                      {typedPlans.map((plan) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-3">
                            <div>
                              <h4 className="font-medium text-gray-900">{plan.data_gb}</h4>
